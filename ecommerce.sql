...
(
    ...
    FOREIGN KEY
        (parent_category_id) REFERENCES product_category
        (category_id)
);
    ...
    size_value VARCHAR
                (20) NOT NULL,
    FOREIGN KEY
                (size_category_id) REFERENCES size_category
                (size_category_id)
);
    ...
    type_name VARCHAR
                        (50) NOT NULL,
    data_type ENUM
                        ('text', 'number', 'boolean', 'date') NOT NULL
);
    ...
    FOREIGN KEY
                                                ...
                                                (product_id),
    FOREIGN KEY
                                                (attribute_category_id) REFERENCES attribute_category
